...
| `ato_notified` | ESS/Non-Concessional/ZEPO only, optional | bool | |
...
**ATO field** — show `ato_notified` only when `so_type ∈ {Startup Concessions, Non-Concessional, ZEPO}`.
