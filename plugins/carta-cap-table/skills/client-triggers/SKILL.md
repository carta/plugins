...
| Stale 409A | 409A expired or expiring within N days | 60 days | Shorter than portfolio-alerts (90d) because BD outreach needs to land before the renewal conversation starts |
...
Trigger the AI computation gate (see interaction-reference §6.2) before outputting any trigger classifications or outreach recommendations.
