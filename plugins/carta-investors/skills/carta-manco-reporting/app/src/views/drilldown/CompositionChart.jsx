...
export default function CompositionChart({ kind, monthly, items, labelSingular, highlightIndex, height = 140 }) {
  if (kind === "monthly") {
    ...
    return (
      <InkBarChart
        ...
        colorFor={(_v, i) => (i === highlightIndex ? "var(--ink)" : "var(--ink-color-global-data-viz-lime-3)")}
